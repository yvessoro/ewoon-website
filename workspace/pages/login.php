                    ...
                    <div class="authentication-form-2 mx-auto">
                        <div class="tab-content" id="animate-tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane show active" id="singin" aria-labelledby="singin-tab">
                                ...
                                <form action="business/connexion.php" method="post">
                                    <label class="radio-inline">
                                        <input type="radio" name="radioType" value="annonceur" checked>&nbsp;&nbsp; Je suis annonceur
                                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label class="radio-inline">
                                        <input type="radio" name="radioType" value="administrateur">&nbsp;&nbsp; Je suis administrateur
                                    </label><br><br><br>
