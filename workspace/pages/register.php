                        ...
                        <div class="tab-content" id="animate-tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane show active" id="singin" aria-labelledby="singin-tab">
                                ...
                                <?php if ($_GET["created"]=="false") { ?>
                                    <p style="color:#FF0000;">Une erreur s'est produite, veuillez réessayer svp</p><br>
                                <?php } ?>
                                <?php if ($_GET["error"]=="existed") { ?>
                                    <p style="color:#FF0000;">Un compte existe déjà avec le mail utilisé</p><br>
                                <?php } ?>
                                <form action="business/add_user.php" method="post">
